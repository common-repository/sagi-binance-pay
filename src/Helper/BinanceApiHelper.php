...
use GSMBinancePay\WC\Exception\BinancePayException;

class BinanceApiHelper {
	const RATES_CACHE_KEY = 'gsmbinancepay_exchange_rates';
	...
	public static function getExchangeRate(string $stableCoin, string $storeCurrency): float {
		...
		$client = new \GSMBinancePay\WC\Client\CoingeckoClient();
		try {
